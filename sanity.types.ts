...
// Query: *[_type == "order" && clerkUserId == $userId] | order(orderDate desc) {      _id,      orderNumber,      orderDate,      status,      totalAmount,      products[]{        ...,        product->      }    }
...
// Query: *[            _type == "sales"            && isActive == true            && couponCode == couponCode        ] | order(validFrom desc){            _id,            saleTitle,            saleDescription,            discountAmount,            couponCode,            validFrom,            validUntil,            isActive            }[0]
